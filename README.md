...
- 项目级 AI 问答
- AI 投资研究报告生成
- 投中交易执行、投委审批、交割条件与证据门禁
- 投后 KPI、周期观测、自动风险事件与处置闭环
- 受控持续数据源与可追溯投资意见版本
- 固定投前/投中/投后专业评测集与 CI 金融质量门禁
- 预览账号共享的每日 AI 用量门禁（问答、报告与文档 AI 解析合计 10 次）
- Dashboard 统计面板

## 技术栈

- Backend: Python 3.14, FastAPI, Pydantic, SQLAlchemy, PostgreSQL, pgvector, Alembic, Redis, Celery, boto3, OpenAI SDK
...
- [docs/financial-quality.md](./docs/financial-quality.md)
