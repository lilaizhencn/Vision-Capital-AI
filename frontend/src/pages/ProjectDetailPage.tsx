  ...
  return (
    <div className="page-stack">
      ...
      <Tabs items={[
        ...
        { key: "files", label: "文档资料", children: <Card className="glass-card" extra={<><Upload {...uploadProps} disabled={submitting}><Button disabled={submitting}>选择文件</Button></Upload><Button type="primary" loading={submitting} disabled={!selectedFiles.length || submitting} onClick={() => void submitBatch()}>开始批量解析</Button></>}>
